...
public class EmptyView extends RelativeLayout {
    public EmptyListener mEmptyListener;
    ...
    private void init(Context context) {
        ...
        view.findViewById(R.id.button_check_again).setOnClickListener(
                view1 -> {
                    if (context instanceof EmptyListener) {
                        mEmptyListener = (EmptyListener) context;
                        mEmptyListener.onCheckAgainClick();
                    }
                });
    }
